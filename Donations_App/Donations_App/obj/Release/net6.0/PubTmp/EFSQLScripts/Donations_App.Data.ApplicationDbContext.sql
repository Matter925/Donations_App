...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230324080933_ModifyModelOPatientCases')
BEGIN
    ALTER TABLE [PatientsCases] ADD [Address] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230324080933_ModifyModelOPatientCases')
BEGIN
    ALTER TABLE [PatientsCases] ADD [DonationCount] int NOT NULL DEFAULT 0;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230324080933_ModifyModelOPatientCases', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230328084953_addNewPatientCaseDate')
BEGIN
    ALTER TABLE [PatientsCases] ADD [PatientCaseDate] datetime2 NOT NULL DEFAULT '0001-01-01T00:00:00.0000000';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230328084953_addNewPatientCaseDate', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230329083206_AddUserIdInPaientCaseModel')
BEGIN
    ALTER TABLE [PatientsCases] ADD [UserId] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230329083206_AddUserIdInPaientCaseModel', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403165637_ModifyModelPatienrCaseV8')
BEGIN
    ALTER TABLE [PatientsCases] ADD [Limit] int NOT NULL DEFAULT 0;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403165637_ModifyModelPatienrCaseV8', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403204833_AddModelGovernorate')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403204833_AddModelGovernorate', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403223214_ModifyGovernorate')
BEGIN
    ALTER TABLE [Governorates] ADD [EnName] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403223214_ModifyGovernorate', N'7.0.2');
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403223302_addDataToGovernorates', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403224732_deleteModelGovernorate')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403224732_deleteModelGovernorate', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403224909_addGovernorateagin')
BEGIN
    CREATE TABLE [Governorates] (
        [Id] int NOT NULL IDENTITY,
        [Name] nvarchar(max) NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403224909_addGovernorateagin', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403231452_adddatainsert')
BEGIN
    INSERT INTO Governorates (Name ,EnName) VALUES ('القاهرة', 'Cairo'),('الجيزة', 'Giza'),( 'الأسكندرية', 'Alexandria'),('الدقهلية', 'Dakahlia'),( 'البحر الأحمر', 'Red Sea'),('البحيرة', 'Beheira'),('الفيوم', 'Fayoum'),('الغربية', 'Gharbiya'),('الإسماعلية', 'Ismailia'),('المنوفية', 'Menofia'),('المنيا', 'Minya'),( 'القليوبية', 'Qaliubiya'),('الوادي الجديد', 'New Valley'),('السويس', 'Suez'),('اسوان', 'Aswan'),('اسيوط', 'Assiut'),('بني سويف', 'Beni Suef'),('بورسعيد', 'Port Said'),( 'دمياط', 'Damietta'),( 'الشرقية', 'Sharkia'),('جنوب سيناء', 'South Sinai'),( 'كفر الشيخ', 'Kafr Al sheikh'),('مطروح', 'Matrouh'),('الأقصر', 'Luxor'),('قنا', 'Qena'),('شمال سيناء', 'North Sinai'),( 'سوهاج', 'Sohag'); 
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403231452_adddatainsert', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403232121_Delete2')
BEGIN
    DROP TABLE [Governorates];
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403232121_Delete2', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403233916_gbhjbj')
BEGIN
    CREATE TABLE [Governorates] (
        [Id] int NOT NULL IDENTITY,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403233916_gbhjbj', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403234329_rttcfc')
BEGIN
    INSERT INTO Governorates (Name ,EnName) VALUES ('القاهرة', 'Cairo'),('الجيزة', 'Giza'),( 'الأسكندرية', 'Alexandria'),('الدقهلية', 'Dakahlia'),( 'البحر الأحمر', 'Red Sea'),('البحيرة', 'Beheira'),('الفيوم', 'Fayoum'),('الغربية', 'Gharbiya'),('الإسماعلية', 'Ismailia'),('المنوفية', 'Menofia'),('المنيا', 'Minya'),( 'القليوبية', 'Qaliubiya'),('الوادي الجديد', 'New Valley'),('السويس', 'Suez'),('اسوان', 'Aswan'),('اسيوط', 'Assiut'),('بني سويف', 'Beni Suef'),('بورسعيد', 'Port Said'),( 'دمياط', 'Damietta'),( 'الشرقية', 'Sharkia'),('جنوب سيناء', 'South Sinai'),( 'كفر الشيخ', 'Kafr Al sheikh'),('مطروح', 'Matrouh'),('الأقصر', 'Luxor'),('قنا', 'Qena'),('شمال سيناء', 'North Sinai'),( 'سوهاج', 'Sohag'); 
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403234329_rttcfc', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403234804_jhb')
BEGIN
    DROP TABLE [Governorates];
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403234804_jhb', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403235020_hgvg')
BEGIN
    CREATE TABLE [Governorates] (
        [Id] int NOT NULL IDENTITY,
        [Name] nvarchar(max) COLLATE Arabic_CI_AI NOT NULL,
        [EnName] nvarchar(max) NOT NULL,
        CONSTRAINT [PK_Governorates] PRIMARY KEY ([Id])
    );
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403235020_hgvg', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403235129_huyfgvt')
BEGIN
    INSERT INTO Governorates (Name ,EnName) VALUES ('القاهرة', 'Cairo'),('الجيزة', 'Giza'),( 'الأسكندرية', 'Alexandria'),('الدقهلية', 'Dakahlia'),( 'البحر الأحمر', 'Red Sea'),('البحيرة', 'Beheira'),('الفيوم', 'Fayoum'),('الغربية', 'Gharbiya'),('الإسماعلية', 'Ismailia'),('المنوفية', 'Menofia'),('المنيا', 'Minya'),( 'القليوبية', 'Qaliubiya'),('الوادي الجديد', 'New Valley'),('السويس', 'Suez'),('اسوان', 'Aswan'),('اسيوط', 'Assiut'),('بني سويف', 'Beni Suef'),('بورسعيد', 'Port Said'),( 'دمياط', 'Damietta'),( 'الشرقية', 'Sharkia'),('جنوب سيناء', 'South Sinai'),( 'كفر الشيخ', 'Kafr Al sheikh'),('مطروح', 'Matrouh'),('الأقصر', 'Luxor'),('قنا', 'Qena'),('شمال سيناء', 'North Sinai'),( 'سوهاج', 'Sohag'); 
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403235129_huyfgvt', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403235407_klib')
BEGIN
    DROP TABLE [Governorates];
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403235407_klib', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230403235606_jhjhh')
BEGIN
    CREATE TABLE [Governorates] (
        [Id] int NOT NULL IDENTITY,
        [Name] nvarchar(max) NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230403235606_jhjhh', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230404084459_addModelCity')
BEGIN
    CREATE TABLE [Cities] (
        [Id] int NOT NULL IDENTITY,
        [Name] nvarchar(max) NOT NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230404084459_addModelCity', N'7.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230404112708_ModifyPatientCaseV12')
BEGIN
    EXEC sp_rename N'[PatientsCases].[Limit]', N'Rate', N'COLUMN';
END;
GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230404112708_ModifyPatientCaseV12')
BEGIN
    ALTER TABLE [PatientsCases] ADD [LimitTime] int NOT NULL DEFAULT 0;
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230404112708_ModifyPatientCaseV12', N'7.0.2');
END;
GO
